...
(function ($) {
      ...
      [
        ...
        },
        {
          ...
          value: function _setupEventHandlers() {
            ...
            $(this.spanSecondes).on("click", this.showView.bind(this, "secondes"));
          },
        },
        {
          key: "_removeEventHandlers",
        ...
        },
        {
          ...
          value: function _handleDocumentClickEnd(e) {
            ...
            } else if (this.currentView === "minutes") {
              this.showView("secondes", this.options.duration / 2);
            } else if (this.options.autoClose) {
              $(this.secondesView).addClass("timepicker-dial-out");
              setTimeout(function () {
                _this58.done();
            ...
            if (typeof this.options.onSelect === "function") {
              this.options.onSelect.call(this, this.hours, this.minutes, this.secondes);
            }
        ...
        },
        {
          ...
          value: function _setupVariables() {
            ...
            this.secondesView = this.modalEl.querySelector(".timepicker-secondes");
            this.spanHours = this.modalEl.querySelector(".timepicker-span-hours");
            this.spanMinutes = this.modalEl.querySelector(".timepicker-span-minutes");
            this.spanSecondes = this.modalEl.querySelector(".timepicker-span-secondes");
        ...
        {
          key: "_buildSecondesView",
          value: function _buildSecondesView() {
            var $tick = $('<div class="timepicker-tick"></div>');
            // Secondes view
            for (var i = 0; i < 60; i += 5) {
              var tick = $tick.clone();
              ...
              tick.html(Timepicker._addLeadingZero(i));
              this.secondesView.appendChild(tick[0]);
            }
          },
        },
        {
        ...
        },
        {
          ...
          value: function _updateTimeFromInput() {
            ...
            this.secondes = +value[2] || 0;
            this.spanHours.innerHTML = this.hours;
            this.spanMinutes.innerHTML = Timepicker._addLeadingZero(this.minutes);
            this.spanSecondes.innerHTML = Timepicker._addLeadingZero(this.secondes);
        ...
        },
        {
          ...
          value: function showView(view, delay) {
            ...
            $(this.spanSecondes).toggleClass("text-primary", !isHours && !isMinutes);

            // Transition view
            if (isHours) {
              this.minutesView.classList.add("timepicker-dial-out");
              this.secondesView.classList.add("timepicker-dial-out");
            } else if (isMinutes) {
              this.hoursView.classList.add("timepicker-dial-out");
              this.secondesView.classList.add("timepicker-dial-out");
            } else {
              this.hoursView.classList.add("timepicker-dial-out");
              this.minutesView.classList.add("timepicker-dial-out");
        ...
        },
        {
          ...
          value: function setHand(x, y, roundBy5) {
            ...
            var radian = Math.atan2(x, -y),
              ...
              isMinutes = this.currentView === "minutes",
            ...
            if (isHours) {
              this["spanHours"].innerHTML = Timepicker._addLeadingZero(value);
            } else if (isMinutes) {
              this["spanMinutes"].innerHTML = Timepicker._addLeadingZero(value);
            } else {
              this["spanSecondes"].innerHTML = Timepicker._addLeadingZero(value);
            }
          ...
          value: function done(e, clearValue) {
            ...
            var value = clearValue
              ...
              : Timepicker._addLeadingZero(this.hours) +
                ...
                ":" +
                Timepicker._addLeadingZero(this.secondes);
            this.time = value;
  ...
  Timepicker._template = [
    ...
    ":",
    '<span class="timepicker-span-secondes"></span>',
    "</div>",
    ...
    '<div class="timepicker-dial timepicker-secondes timepicker-dial-out"></div>',
    "</div>",
...
(function ($, anim) {
  ...
  var Range = (function (_Component21) {
    ...
    function Range(el, options) {
      ...
      _this72.options = $.extend(
        {
          thumbCalculator: function thumbCalculator(input, value) {
            return value;
          },
        },
        Range.defaults,
      ...
      [
        ...
        },
        {
          ...
          value: function _handleRangeChange() {
            $(this.value).html(this.options.thumbCalculator(this.input, this.$el.val()));
        ...
        },
        {
          ...
          value: function _setupThumb() {
            ...
            $(this.thumb).append(this.options.thumbCalculator(this.input, this.value));
  ...
  Range.init($("input[type=range]:not(.date-range)"));
  Range.init($("input[type=range].date-range"), {
    thumbCalculator: function thumbCalculator(input, value) {
      if (isNaN(value)) {
        return value;
      }

      value = parseInt(value) / 1000.0;

      var min = parseInt(input.getAttribute("min-date")) || 0;
      var max = parseInt(input.getAttribute("max-date")) || 100;
      var date = new Date(min + value * (max - min));
